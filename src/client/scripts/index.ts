...
import { onModelsDropdownSearch, onModelsDropdownSearchBlur } from "src/client/scripts/modules/models-dropdown"
...
declare global {
  interface Window {
    ...
    // models dropdown
    onModelsDropdownSearch: (event: Event) => void
    onModelsDropdownSearchBlur: (value: string, options: string, id: string) => void
    // dropdown
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // const userMessages = document.querySelectorAll("[data-message-container]")
  // userMessages.forEach((message) => {
  //   const textContent = message.textContent
  //   if (textContent?.includes("<script>")) {
  //     // eslint-disable-next-line no-useless-escape
  //     message.textContent = textContent.replaceAll("</script>", "<\/script>")
  //   }
  // })
...
// models dropdown
window.onModelsDropdownSearch = onModelsDropdownSearch
window.onModelsDropdownSearchBlur = onModelsDropdownSearchBlur
