...
const History = ({
  ...
  return (
    <>
      <div
        id="history-list"
        class={"sidebar__body px-4 h-[calc(100vh-266px)] !mt-[146px] md:hidden"}
      ...
      <div class={"hidden fixed top-0 left-[255px] w-[calc(100vw-255px)] md:flex items-center justify-center h-full"}>
